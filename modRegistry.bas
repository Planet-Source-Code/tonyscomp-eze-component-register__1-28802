...
Public Function bSetRegValue(ByVal hKey As hKey, ByVal lpszSubKey As String, ByVal sSetValue As String, ByVal sValue As String) As Boolean
...
Public Function bGetRegValue(ByVal hKey As hKey, ByVal sKey As String, ByVal sSubKey As String) As String
